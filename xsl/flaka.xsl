...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
      ...
      where flaka[.cls] is my own class and where I easily can change the 
      document into an article, a book, change the font size etc. without the need
