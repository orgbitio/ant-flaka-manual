...
# ======================================================================
# 
# This is a modified version of the original XSL stylesheet (see origins
# below) which turns my DB4 document into a valid DB5 document. The main
# problems:
# 1. create article/info/title if no title exists
    ...
    <xsl:when test="not(dedicationinfo|prefaceinfo|chapterinfo
      ...
      <xsl:copy>
        ...
        <info>
          ...
          <xsl:if test="not(title|subtitle|titleabbrev)">
